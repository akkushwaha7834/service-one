  ...
  <div class="container">
    <div class="row gy-4 align-items-center">
      <div class="col-md-6">
        ...
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum inventore, commodi pariatur maiores quaerat, cupiditate, distinctio quibusdam laudantium reiciendis nobis et aliquid. Eaque rerum, magnam repellat quisquam quod doloribus reprehenderit magni sint quas commodi culpa enim dolorem obcaecati veniam similique cupiditate molestiae consequuntur possimus eligendi nisi, incidunt voluptates eos! Optio.</p>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum inventore, commodi pariatur maiores quaerat, cupiditate, distinctio quibusdam laudantium reiciendis nobis et aliquid. Eaque rerum, magnam repellat quisquam quod doloribus reprehenderit magni sint quas commodi culpa enim dolorem obcaecati veniam similique cupiditate molestiae consequuntur possimus eligendi nisi, incidunt voluptates eos! Optio.</p>
        <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Dolorum inventore, commodi pariatur maiores quaerat, cupiditate, distinctio quibusdam laudantium reiciendis nobis et aliquid. Eaque rerum, magnam repellat quisquam quod doloribus reprehenderit magni sint quas commodi culpa enim dolorem obcaecati veniam similique cupiditate molestiae consequuntur possimus eligendi nisi, incidunt voluptates eos! Optio.</p>
      </div>
...
<section class="bg-light">
  <div class="container">
    <div class="row gy-4">
      <div class="col-12 text-center">
        <h2 class="text-primary mb-0">Pricing</h2>
      </div>
      <div class="col-lg-8 offset-lg-2">
        <div class="table-responsive">
          <table class="table table-striped table-hover model-list-table text-nowrap">
            <thead>
              <tr>
            ...
            <tbody>
              <tr>
                <th scope="row">Independent call girl</th>
                <td>₹5,000</td>
                <td>₹19,000</td>
              </tr>
              <tr>
                <th scope="row">Airhostess call girls</th>
                <td>₹7,000</td>
                <td>₹29,000</td>
              </tr>
              <tr>
                <th scope="row">College call girl</th>
                <td>₹9,000</td>
                <td>₹30,000</td>
              </tr>
              <tr>
                <th scope="row">Housewife call girls</th>
                <td>₹17,000</td>
                <td>₹45,000</td>
              </tr>
              <tr>
                <th scope="row">Russian escort service</th>
                <td>₹21,000</td>
                <td>₹50,000</td>
              </tr>
            </tbody>
              ...
              <div class="col-lg-8">
                <div class="card-body">
                  ...
                  <p class="card-text text-body-secondary text-end">
                    ...
                    <a href="#" class="badge rounded-pill text-bg-primary">
