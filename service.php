    ...
    <div class="container">
        <div class="row gy-4">
            <div class="col-lg-10 offset-lg-1 text-center">
                <h2>100% Verified escort and call girl service in India</h2>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Velit quo possimus tenetur blanditiis non sed quidem nam? Inventore ratione magni saepe cumque cupiditate suscipit quam natus nemo veritatis aliquam dicta, sequi dolorem quisquam odit. Quam, repellendus aperiam? Expedita, pariatur voluptatum.</p>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Fuga qui itaque laboriosam id, doloribus commodi non!</p>
            </div>
        </div>
    </div>
</section>
            ...
            <?php for ($i = 0; $i < 5; $i++) { ?>
                <div>
                    <ul class="list-unstyled d-flex flex-column gap-2 mb-0">
                        <li class="d-flex gap-2 align-items-center p-2 bg-body-tertiary rounded">
                            <span>
